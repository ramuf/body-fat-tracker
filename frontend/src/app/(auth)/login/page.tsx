...
export const metadata: Metadata = {
  title: "Login - Body Fat Tracker",
  description: "Sign in to your Body Fat Tracker account",
}
  ...
  return (
    <div className="h-screen w-full flex overflow-hidden bg-[#020617]">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 max-w-lg px-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <p className="text-lg text-slate-400 mb-10 leading-relaxed">
            Join thousands of users tracking their journey to better health.
            Get precise insights, visualize trends, and stay motivated.
          </p>

          <div className="grid grid-cols-2 gap-6">
            <div className="p-4 rounded-xl bg-slate-900/40 border border-indigo-500/10 backdrop-blur-sm">
              <div className="text-violet-400 font-semibold mb-1">Smart Tracking</div>
              <div className="text-sm text-slate-500">Visual charts & trend analysis</div>
            </div>
            <div className="p-4 rounded-xl bg-slate-900/40 border border-indigo-500/10 backdrop-blur-sm">
              <div className="text-pink-400 font-semibold mb-1">Secure Data</div>
              <div className="text-sm text-slate-500">Private & encrypted storage</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-sm space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 relative z-10">
          ...
          <div className="bg-slate-950/50 p-8 rounded-3xl border border-white/10 backdrop-blur-md shadow-2xl">
            <LoginForm />
          </div>
